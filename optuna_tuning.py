...
# Current best parameters with xgbclassifier model:
# Best is trial 79 with value: 0.6705632306057385.
# Best value: 0.6705632306057385
# Best params: 

# {'lambda': 0.02346830703895387, 'alpha': 9.956365178312454, 'tree_method': 'gpu_hist', 'objective': 'binary:logistic', 'verbosity': 0, 'n_jobs': -1, 'learning_rate': 0.030042259864304366, 'min_child_weight': 19, 'max_depth': 12, 'max_delta_step': 8, 'subsample': 0.21684497186514273, 'colsample_bytree': 0.7003826597151147, 'gamma': 0.02156806207076522, 'n_estimators': 147, 'eta': 0.15337337361538475}
